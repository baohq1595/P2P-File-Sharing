...
//	private String recMssg;
//	private String sendMssg;
...
//	private ByteBuffer byteBuffer;
	...
	public Downloader(PeerInfo peer, String file,String folderDownload, 
			String hash, ArrayList<DownloadList> pieceList,long lengFile,int posi,ExecutorService a) {
...
//                else {
		...
		try {
			...
			//byteRead = inStream.read(peerIDBuffer, 0, Tag.PEER_ID_SIZE);
			//EDITED BY MRKEYS			
                        ...
                        try{			                    
                            ...
                            for (int piece : pieceList) {
                                do{
                                    ...
                                    /*for(int i = 0; i < endfor + 1; i++){                                        
                                        if (i == endfor) inStream.read(recBuffer, i*8192, Tag.BUFFER_SIZE+Tag.MSSG_SIZE - i*8192);
                                        else inStream.read(recBuffer, i*8192, 8192);
