...
public class KeepConnection {
    private String fileName ;//= "E:\\9000M_PBr5.0.0_rel1748_PL5.2.0.95_A5.0.0.1079.exe";
    private String fileRequest ;//= "E:\\9000M_PBr5.0.0_rel1748_PL5.2.0.95_A5.0.0.1079.exe";
    ...
    public KeepConnection(String fileName, String hashValueRequest, ArrayList<FileInfo> fileList, ArrayList<PeerInfo> peerList,
    			String UID, int mode, String ip, int port, String NAME,int portUP,String keySearch) {
...
//        boolean running;
//        running = true;
//        withTracker wT = new withTracker();
...
//	    	File fisRe = new File (fileRequest);
//		    hashValueRequest = ins.toSHAValue(fisRe);
                ...
                try {
                    switch(mode){
                        ...
                        case 1:
                            ...
                            outStream.flush();
                            inStream.read(mssgBuff); 
                          //  outStream.write(Tag.MSSG_ACTION_SEND.getBytes());
                           // outStream.flush();
                        ...
                        case 3:
                                ...
                                if (mssg.equals(Tag.MSSG_TYPE_TER)) break;
                                else {
                                    // = null;
                                    for (int i =0;i<4;i++)
                        ...
                        case 4:        
                                try {
                                    //System.out.println("Send mode 4 "+ Tag.KEEP_ALIVE);
